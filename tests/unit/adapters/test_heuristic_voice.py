...
class TestSentencesAParentActuallySays:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            ("I want to cook this with him", IntentType.COOK),
            ("we should bake this recipe together", IntentType.COOK),
            ("I want to visit the museum with him", IntentType.VISIT),
            ("we should take him to the zoo", IntentType.VISIT),
            ("I want to tell him the story of how we met", IntentType.TELL),
            ("tell him about his grandmother", IntentType.TELL),
            ("I want him to listen to this song", IntentType.LISTEN),
            ("we should listen to this together", IntentType.LISTEN),
